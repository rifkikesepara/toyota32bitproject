...
| name      | type                                    | Description                                                                                                                                                              |
| --------- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| disabled  | bool                                    | `Defines whether the component will be shown or not.`                                                                                                                    |
...
| onInit    | _function_                              | `The function that is executed whenever component is initialized.`                                                                                                       |
...
This component is used for picking a date from 3 seperate select components which is **CustomSelectComponent**.

**PROPS**

| name      | type             | Description                                                                  |
| --------- | ---------------- | ---------------------------------------------------------------------------- |
| startDate | _object_         | `Date value that will be shown whenever the component appears`               |
| disabled  | _bool_           | `Defines whether the component will be shown or not.`                        |
| date      | _function(date)_ | `The function that gives you the current date value that has been selected.` |
